...
export const PRODUCTOS_ELIMINADAS_API = '/api/productos/eliminadas';
...
export const PUBLIC_SUCURSAL_ESTADO_API = '/api/public/sucursal/estado';
...
export const PUBLIC_PEDIDO_ESTADO_API = (orderId: number | string) =>
  `/api/public/pedido/${orderId}/estado`;
